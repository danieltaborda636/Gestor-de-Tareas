...
<!-- ///////////////////////////////////
    USAREMOS TODO LO DE LA PAGINA DE INICIO PARA QUE SE VEAN IGUAL  LAS PAGINAS
    //////////////////////////////////// -->
    <?php
...
<body>
   ...
   <form method="POST" action="<?= BASE_URL ?>controllers/TaskController.php?action=create">
